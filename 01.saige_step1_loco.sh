...
#SBATCH -e /n/holylfs05/LABS/kraft_lab/Lab/KCPS2/data/SAIGE_output/loco/step1.loco_%A_%a.err
#SBATCH -o /n/holylfs05/LABS/kraft_lab/Lab/KCPS2/data/SAIGE_output/loco/step1.loco_%A_%a.out
#SBATCH --array=0-35
...
Rscript /n/holylfs05/LABS/kraft_lab/Lab/yjee/SAIGE/extdata/step1_fitNULLGLMM.R     \
